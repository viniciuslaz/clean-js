...
describe("Cadastrar usuario UseCase", function () {
  ...
  test("Deve retornar um Either.Left se ja existir um cadastro com o CPF", async function () {
  ...
  test("Deve retornar um Either.Left se ja existir um cadastro com o Email", async function () {
